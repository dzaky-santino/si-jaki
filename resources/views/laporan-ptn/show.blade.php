            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('laporan-ptn.printToPdf', ['uuid' => $ptn->uuid, 'jenis_kegiatan' => request('jenis_kegiatan'), 'filter_year' => request('filter_year'), 'filter_month' => request('filter_month'), 'filter_pokja' => request('filter_pokja')]) }}"
                            ...
                            <div>
                                ...
                                <div class="timeline-item animated-card">
                                    ...
                                    <div class="timeline-footer row mx-0">
                                        ...
                                        @if ($item->canEdit)
                                        <div class="col-6 col-md-3 mb-2 px-1">
                                            <a href="{{ route('laporan-ptn.edit', $item->uuid) }}"
                                                class="btn btn-warning btn-block btn-sm">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </div>
                                        <div class="col-6 col-md-3 mb-2 px-1">
                                            <form action="{{ route('laporan-ptn.destroy', $item->uuid) }}" method="POST"
