...
return new class extends Migration
{
    ...
    {
        Schema::create('laporan_pts', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->foreignId('pts_id')->constrained('pts')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('laporan_pts');
    }
};
